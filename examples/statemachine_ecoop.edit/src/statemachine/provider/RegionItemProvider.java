...
/**
 * This is the item provider adapter for a {@link statemachine.Region} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RegionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Region_initial_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Region_initial_feature", "_UI_Region_type"),
				 StatemachinePackage.Literals.REGION__INITIAL,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StatemachinePackage.Literals.REGION__STATE);
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StatemachinePackage.Literals.REGION__STATE,
