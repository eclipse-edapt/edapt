...
public class GMFGenMetamodelAdaptationTest extends TestBase {
	...
	public void testHistory() throws Exception {
		...
		URI targetMetamodelURI = metamodelsURI.appendSegment("gmfgen.ecore");
		URI expectedMetamodelURI = metamodelsURI.appendSegment("gmfgen_1.248.ecore");
	...
	public void testAdaptation() throws Exception {
		...
		URI metamodelsURI = contextURI.appendSegment("metamodels");
		URI sourceMetamodelURI = metamodelsURI.appendSegment("gmfgen_1.139.ecore");
		URI targetMetamodelURI = metamodelsURI.appendSegment("gmfgen2.ecore");
		URI expectedMetamodelURI = metamodelsURI.appendSegment("gmfgen_1.248.ecore");
