 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.edapt.cope.migration.impl.SlotImpl#getInstance <em>Instance</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class SlotImpl extends EObjectImpl implements Slot {
	...
	public Instance getInstance() {
		if (eContainerFeatureID() != MigrationPackage.SLOT__INSTANCE) return null;
	...
	public void setInstance(Instance newInstance) {
		if (newInstance != eInternalContainer() || (eContainerFeatureID() != MigrationPackage.SLOT__INSTANCE && newInstance != null)) {
			...
			if (newInstance != null)
				msgs = ((InternalEObject)newInstance).eInverseAdd(this, MigrationPackage.INSTANCE__SLOTS, Instance.class, msgs);
			msgs = basicSetInstance(newInstance, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MigrationPackage.SLOT__INSTANCE, newInstance, newInstance));
	}
