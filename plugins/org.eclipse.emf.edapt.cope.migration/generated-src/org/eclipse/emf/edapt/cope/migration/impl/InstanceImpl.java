 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.edapt.cope.migration.impl.InstanceImpl#getSlots <em>Slots</em>}</li>
 *   <li>{@link org.eclipse.emf.edapt.cope.migration.impl.InstanceImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.eclipse.emf.edapt.cope.migration.impl.InstanceImpl#getReferences <em>References</em>}</li>
 *   <li>{@link org.eclipse.emf.edapt.cope.migration.impl.InstanceImpl#getUri <em>Uri</em>}</li>
 *   <li>{@link org.eclipse.emf.edapt.cope.migration.impl.InstanceImpl#getUuid <em>Uuid</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InstanceImpl extends EObjectImpl implements Instance {
	...
	private <V> V getAttributeValue(EAttribute attribute) {
		...
		EList<Object> values = new UpdatingList(this, attribute, ((AttributeSlot) slot).getValues());
		if(attribute.isMany()) {
			return (V) values;
		}
	...
	<V> V getReferenceValue(EReference reference) {
		...
		EList<Instance> values = new UpdatingList(this, reference, ((ReferenceSlot) slot).getValues());
		if(reference.isMany()) {
			return (V) values;
		}
		else if(!values.isEmpty()) {
	...
	public void set(EStructuralFeature feature, Object newValue) {
		if(feature.isMany()) {
			...
			if (newValue instanceof List<?>) {
				throw new RuntimeException("Single value expected, but list found");
			}
	...
	/**
	 * Get the slot for an instance's attribute
	...
	/**
	 * Get the slot for an instance's reference
	 * (create one if there is none)
	 * 
	 * @param reference
	 * @return Slot
	...
	public void remove(EStructuralFeature feature, int index) {
		if(feature instanceof EAttribute) {
			...
			if(opposite != null && reference.eContainer() != null) {
				...
				int oppositeIndex = ((ReferenceSlot) target.getSlot(opposite)).getValues().indexOf(this);
	...
	/**
	 * Remove a value from an instance's attribute
	...
	/**
	 * Remove a value from an instance's reference
	 * (delete slot if it is empty)
	 * 
	 * @param reference
	 * @param index
	...
	public EList<EObject> eContents() {
		if(getType().getModel().isReflection()) {
		    EStructuralFeature [] features = ((EClassImpl.FeatureSubsetSupplier) getEClass().getEAllStructuralFeatures()).containments();
	...
	public EList<EObject> eCrossReferences() {
		if(getType().getModel().isReflection()) {
		    EStructuralFeature [] features = ((EClassImpl.FeatureSubsetSupplier) getEClass().getEAllStructuralFeatures()).crossReferences();
		    return new EContentsEList<EObject>(this, features);
		}
