 ...
 */
@Operation(identifier = "subClassesToEnumeration", label = "Sub Classes to Enumeration", description = "In the metamodel, the subclasses of a class are replaced by an enumeration. An enumeration with literals for all subclasses is created and an enumeration attribute is created in the class. Finally, all subclasses are deleted, and the class is made concrete. In the model, instances of a subclass are migrated to the class, setting the enumeration attribute to the appropriate literal.")
public class SubClassesToEnumeration extends OperationBase {

	/** {@description} */
	@Parameter(description = "The context class")
	public EClass contextClass;

	/** {@description} */
	@Parameter(description = "The name of the enumeration attribute")
	...
	/** {@description} */
	@Parameter(description = "The name of the enumeration")
