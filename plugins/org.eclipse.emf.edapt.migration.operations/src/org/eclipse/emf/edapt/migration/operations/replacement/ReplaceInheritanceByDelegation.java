...
public class ReplaceInheritanceByDelegation extends OperationBase {
	...
	/** {@description} */
	@Parameter(description = "The class from which the super class is removed")
	public EClass subClass;

	/** {@description} */
	@Parameter(description = "The super class to be removed")
	...
	/** {@description} */
	@Parameter(description = "The name of the reference to the super class")
