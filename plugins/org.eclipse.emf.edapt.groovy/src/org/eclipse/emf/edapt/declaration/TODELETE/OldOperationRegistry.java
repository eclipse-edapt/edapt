...
public class OldOperationRegistry {
	 ...
	 * Singleton instance
	 */
	private static OldOperationRegistry instance;
	 ...
	 * @return Instance
	 */
	public static OldOperationRegistry getInstance() {
		if (instance == null) {
			instance = new OldOperationRegistry();
		}
		return instance;
	}
