...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.edapt.cope.history.Create} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CreateItemProvider
	...
	public String getText(Object object) {
		Create element = (Create) object;
		EObject element1 = element.getElement();
		String elementLabel = element1.eClass().getName() + " "
				+ HistoryUIUtils.getBracedLabel(element1);
		
		String label = elementLabel + " has been created";
		
		if (element.getTarget() != null) {
			String targetLabel = HistoryUIUtils.getBracedLabel(element
					.getTarget());
			label += " in " + targetLabel;
		}
