...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.edapt.declaration.Placeholder} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PlaceholderItemProvider
	...
	protected void addInitExpressionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Placeholder_initExpression_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Placeholder_initExpression_feature", "_UI_Placeholder_type"),
				 DeclarationPackage.Literals.PLACEHOLDER__INIT_EXPRESSION,
				 true,
				 true,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Placeholder)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Placeholder_type") :
			getString("_UI_Placeholder_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Placeholder.class)) {
