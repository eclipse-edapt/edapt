 ...
 *******************************************************************************/
package org.eclipse.emf.edapt.cope.declaration.provider;
...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.edapt.cope.declaration.TypedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TypedElementItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TypedElement_many_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TypedElement_many_feature", "_UI_TypedElement_type"),
				 DeclarationPackage.Literals.TYPED_ELEMENT__MANY,
				 true,
				 false,
				 false,
	...
	protected void addClassifierPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TypedElement_classifier_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TypedElement_classifier_feature", "_UI_TypedElement_type"),
				 DeclarationPackage.Literals.TYPED_ELEMENT__CLASSIFIER,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addClassifierNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TypedElement_classifierName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TypedElement_classifierName_feature", "_UI_TypedElement_type"),
				 DeclarationPackage.Literals.TYPED_ELEMENT__CLASSIFIER_NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((TypedElement)object).getClassifierName();
