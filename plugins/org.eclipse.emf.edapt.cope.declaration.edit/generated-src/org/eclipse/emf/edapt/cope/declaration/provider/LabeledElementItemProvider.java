...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.edapt.cope.declaration.LabeledElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LabeledElementItemProvider
	 ...
	 * @generated
	 */
	public LabeledElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((LabeledElement)object).getLabel();
		return label == null || label.length() == 0 ?
			getString("_UI_LabeledElement_type") :
			getString("_UI_LabeledElement_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(LabeledElement.class)) {
			case DeclarationPackage.LABELED_ELEMENT__LABEL:
