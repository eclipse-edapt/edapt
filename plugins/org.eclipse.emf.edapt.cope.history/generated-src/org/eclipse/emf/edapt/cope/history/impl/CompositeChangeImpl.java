 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.edapt.cope.history.impl.CompositeChangeImpl#getChanges <em>Changes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CompositeChangeImpl extends MigrateableChangeImpl implements CompositeChange {
	...
	public EList<PrimitiveChange> getChanges() {
		if (changes == null) {
			changes = new EObjectContainmentEList<PrimitiveChange>(PrimitiveChange.class, this, HistoryPackage.COMPOSITE_CHANGE__CHANGES);
		}
		return changes;
	}
