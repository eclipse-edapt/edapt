...
public class TestSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TestPackage.TEST_SUITE_DEFINITION: {
				TestSuiteDefinition testSuiteDefinition = (TestSuiteDefinition)theEObject;
				T result = caseTestSuiteDefinition(testSuiteDefinition);
				if (result == null) result = caseNamedElement(testSuiteDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TestPackage.TEST_CASE_DEFINITION: {
				TestCaseDefinition testCaseDefinition = (TestCaseDefinition)theEObject;
				T result = caseTestCaseDefinition(testCaseDefinition);
				if (result == null) result = caseNamedElement(testCaseDefinition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseTestSuiteDefinition(TestSuiteDefinition object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseTestCaseDefinition(TestCaseDefinition object) {
		return null;
	}
