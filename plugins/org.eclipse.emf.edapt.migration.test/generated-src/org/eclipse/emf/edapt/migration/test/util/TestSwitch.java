...
public class TestSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case TestPackage.TEST_SUITE_DEFINITION: {
			final TestSuiteDefinition testSuiteDefinition = (TestSuiteDefinition) theEObject;
			T result = caseTestSuiteDefinition(testSuiteDefinition);
			if (result == null) {
				result = caseNamedElement(testSuiteDefinition);
			}
			if (result == null) {
		...
		case TestPackage.TEST_CASE_DEFINITION: {
			final TestCaseDefinition testCaseDefinition = (TestCaseDefinition) theEObject;
			T result = caseTestCaseDefinition(testCaseDefinition);
			if (result == null) {
				result = caseNamedElement(testCaseDefinition);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
